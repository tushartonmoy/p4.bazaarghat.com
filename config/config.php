...
# What is the name of this app?
	define('APP_NAME', 'Assignments Tracker');  
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'mB(cwfEf#)Wih%zASXe44aOg@hh2S8A5XQ3NzSXK');
	define('TOKEN_SALT', '80yqT5VRL5Htah1q6Q4WH$6Wl_MR31FvKsMrvjs8');